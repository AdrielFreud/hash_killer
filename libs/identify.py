...
def run():
    ...
    while True: 
        ...
        if len(jerar)==0: 
            print("")
            print(" Nao Foi encontrada nenhum tipo de HASH.") 
        elif len(jerar)>2: 
            jerar.sort() 
            print("") 
            print("Possiveis Hashs:")
            print("[+] %s"%algorithms[jerar[0]])
            print("[+] %s"%algorithms[jerar[1]])
            print("")
            print("Umas das Formas Possiveis de HASH:")
            for a in range(int(len(jerar))-2): 
                print("[+] %s"%algorithms[jerar[a+2]])
        else: 
            jerar.sort() 
            print("")
            print("Hashs Possiveis:")
            for a in range(len(jerar)): 
                print("[+] %s"%algorithms[jerar[a]])
        sys.exit(0)